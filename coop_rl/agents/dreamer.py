...
def create_train_state(rng, config, obs_shape, act_shape):
    agent = Agent(obs_shape, act_shape, config)
    return TrainState.create(apply_fn=None, params=None, tx=None, key=rng, agent=agent)
