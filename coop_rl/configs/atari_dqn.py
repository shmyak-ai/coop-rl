...
def get_config():
    ...
    controller = config_dict.FieldReference(None, field_type=object)
    buffer = config_dict.FieldReference(None, field_type=object)
    ...
    config.args_collector.args_network = ml_collections.ConfigDict()
    config.args_collector.args_network.num_actions = num_actions
    ...
    config.args_collector.env = HandlerEnvAtari
    config.args_collector.args_env = ml_collections.ConfigDict()
    config.args_collector.args_env.env_name = env_name
    config.args_collector.args_env.stack_size = stack_size
    ...
    config.args_trainer.args_network = ml_collections.ConfigDict()
    config.args_trainer.args_network.num_actions = num_actions
    config.args_trainer.optimizer = optimizer 
    config.args_trainer.args_optimizer = ml_collections.ConfigDict()
    config.args_trainer.args_optimizer.learning_rate = learning_rate
    config.args_trainer.args_optimizer.eps = eps
