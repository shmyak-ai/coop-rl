...
class FourierBasis:
    ...
    def __init__(
        self,
        nvars: int,
        min_vals: float | Sequence[float] = 0.0,
        max_vals: float | Sequence[float] | None = None,
        order: int = 3,
    ):
        self.order = order
...
class JaxFourierDQNNetwork(nn.Module):
    ...
    num_actions: int
    min_vals: Sequence[float] | None = None
    max_vals: Sequence[float] | None = None
