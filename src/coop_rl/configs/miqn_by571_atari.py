...
def get_config():
    # M-IQN config matching, as closely as coop-rl's architecture allows, the reference
    # BY571/IQN-and-Extensions run:
    ...
    config.args_network.args_torso.activation = "relu"  # BY571 conv stack
    ...
    config.args_trainer.args_get_update_step.gamma = 0.99  # BY571 default
    ...
    config.args_trainer.args_get_update_step.num_tau_samples = 32  # -N 32
    config.args_trainer.args_get_update_step.num_tau_prime_samples = 32  # -N 32
    config.args_trainer.args_get_update_step.num_quantile_samples = 32  # -N 32
    config.args_trainer.args_get_update_step.max_abs_reward = 1000.0  # BY571: no reward clip
