...
def main():
    ...
    trainer = conf.trainer.options(max_concurrency=3).remote(**conf.args_trainer, controller=controller)
    collectors = []
    ...
    # remote calls
    trainer_futures = [trainer.training.remote(), trainer.buffer_updating.remote(), trainer.add_traj_seq.remote(1),]
